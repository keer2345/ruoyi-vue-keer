package com.keer.yudaovue.module.systemApi.enums.social;
...
public enum SocialTypeEnum implements IntArrayValuable {
   ...
   *
   * @see <a
   *     href="https://developers.dingtalk.com/document/app/obtain-identity-credentials">接入文档</a>
   */
   ...
   *
   * @see <a
   *     href="https://xkcoding.com/2019/08/06/use-justauth-integration-wechat-enterprise.html">接入文档</a>
   */
   ...
   *
   * @see <a
   *     href="https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/login.html">接入文档</a>
   */
  WECHAT_MINI_APP(34, "WECHAT_MINI_APP"),
  ;

  public static final int[] ARRAYS =
      Arrays.stream(values()).mapToInt(SocialTypeEnum::getType).toArray();
