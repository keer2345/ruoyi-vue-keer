package com.keer.yudaovue.module.systemBiz.dal.dataobject.user;
...
@TableName(
    value = "system_users",
    autoResultMap = true) // 由于 SQL Server 的 system_user 是关键字，所以使用 system_users
...
public class AdminUserDO extends TenantBaseDO {
   ...
   * 加密后的密码
   *
   * <p>因为目前使用 {@link BCryptPasswordEncoder} 加密器，所以无需自己处理 salt 盐
   */
