...
import static com.keer.yudaovue.framework.common.util.ollection.CollectionUtils.convertList;
 ...
 *
 * <p>https://blog.csdn.net/qq_43371556/article/details/100898816
 *
 * <p>https://developer.aliyun.com/article/1299449
 *
...
public class YudaoWebSecurityConfigurerAdapter {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .authorizeHttpRequests(
            r ->
                r
                    ...
                    .permitAll()
                    .requestMatchers(
                        HttpMethod.PUT, permitAllUrls.get(HttpMethod.PUT).toArray(new String[0]))
                    .permitAll()
                    .requestMatchers(
                        HttpMethod.DELETE,
                    ...
                    .permitAll()
                    .requestMatchers(
                        HttpMethod.HEAD, permitAllUrls.get(HttpMethod.HEAD).toArray(new String[0]))
                    .permitAll()
                    .requestMatchers(
                        HttpMethod.PATCH,
                    ...
                    // 1.4 基于 yudao.security.permit-all-urls 无需认证
        ...
        //     todo
        // .authorizeHttpRequests(
        //     c -> authorizeRequestsCustomizers.forEach(customizer -> customizer.customize(c)))
        // ③：兜底规则，必须认证
