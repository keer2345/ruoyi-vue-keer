 ...
 * 方便 {@link com.keer.yudaovue.framework.web.apilog.core.filter.ApiAccessLogFilter} 记录访问日志
 *
 * @author keer
 * @date 2024-04-26
 */
@Slf4j(topic = ">>> GlobalResponseBodyHandler")
@ControllerAdvice
public class GlobalResponseBodyHandler implements ResponseBodyAdvice {
  @Override
  @SuppressWarnings("NullableProblems") // 避免 IDEA 警告
  public boolean supports(MethodParameter returnType, Class converterType) {
    if (ObjUtil.isNull(returnType.getMethod())) {
      return false;
    }
